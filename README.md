...
**Nybizlookup** — Scrape ny biz lookup data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/ny-biz-lookup?style=social)

</div>

> **Search intent:** collect public ny-biz-lookup data for research, enrichment, and monitoring workflows. Related topics: web scraping, python, data extraction, scraper.

## What this project is for

`ny-biz-lookup` is an implementation-focused Python project for collecting public ny-biz-lookup data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/ny-biz-lookup.git
cd ny-biz-lookup
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "ny-biz-lookup", "category": "Custom Scrapers"}
  }
}
```
